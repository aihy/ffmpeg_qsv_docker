...
RUN cd /tmp && wget https://www.ffmpeg.org/releases/ffmpeg-$FFMPEG_VERSION.tar.xz && tar xJf ffmpeg-$FFMPEG_VERSION.tar.xz && cd ffmpeg-$FFMPEG_VERSION && /root/ffmpeg-$FFMPEG_VERSION/configure --arch=x86_64 --enable-x86asm --disable-doc --disable-ffplay --enable-libmfx --enable-libbluray --enable-nonfree --enable-fontconfig --enable-gnutls --enable-gpl --enable-iconv --enable-libass --enable-libfreetype --enable-libfribidi --enable-libmp3lame --enable-libopus --enable-libtheora --enable-libvorbis --enable-libwebp --enable-libx264 --enable-libx265 --enable-libzvbi --enable-version3 --enable-vaapi --target-os=linux && make -j8 && make install
